...
public class Ajanda extends JFrame {
	...
	public Ajanda() {
		...
		// �u anki tarihin ve tarihPanel in bulundu�u panel.
		...
		enYakinHatirlatma = new JButton("En yak�n tarihli hat�rlatma");
		...
		// bunu unutursan heap b�lgesi ta�ar...
	...
	public void connectDatabase() {
		...
		try {
			...
			System.err.println("Veritaban�na ba�lan�lamad�!");
	...
	public void shutDownConnection() {
		try {
			...
			System.err.println("Veritaban� kap�t�lamad�!");
			sqlEX.printStackTrace();
		}
	}
	...
	public void vtKaydet() throws SQLException {
		...
		if (ozelNot.equals("") || tarih.equals("")) {
			JOptionPane.showMessageDialog(null, "Not eklemeyi ve Tarih se�meyi unutmay�n!");
		}
		else {
			connectDatabase();
			// TODO
			JOptionPane.showMessageDialog(null, "Tarih: " + tarih + "\nNot: " + ozelNot, "��lem Ba�ar�l�.", 1);
			shutDownConnection();
			clear();
		}
	}
	...
	public void showDepo() throws SQLException {
		JFrame frame = new JFrame("Creating a Scrollable JTable!");
		  ...
		  Object [] sutunAdlari = {"id", "Tarih", "�zel Not"};
	...
	public class Dinleyici implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == ajandayaEkle) {
				...
				System.out.println("TEST A�AMASINDAYIZ!!!");
			}
